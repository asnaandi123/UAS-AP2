...
public class update {
    ...
    public void update(int nm, String nama, String alamat, String jk, int ang) {
        ...
        try {
            ...
            String sql_alamat = "update datasantri set alamat = '" + alamat + "'where nim = '" + nm + "'";
            String sql_jk = "update datasantri set jeniskelamin = '" + jk + "'where nim = '" + nm + "'";
            String sql_nim1 = "update datasantri set nomorsantri = '" + nm + "'where namasantri = '" + nama + "'";
            String sql_nim2 = "update datasantri set nomorsantri = '" + nm + "'where alamat = '" + alamat + "'";
